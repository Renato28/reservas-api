...
public class HotelController {
    ...
    public ResponseEntity<HotelResponseDto> cadastrar(@Valid @RequestBody HotelDto dto) {
        HotelResponseDto response = hotelService.cadastrar(dto);
    ...
    public ResponseEntity<HotelResponseDto> atualizar(@PathVariable Long id, @RequestBody HotelDto dto) {
        HotelResponseDto hotelAtualizado = hotelService.atualizar(id, dto);
